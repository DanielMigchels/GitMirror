...
public class AzureDevOpsService(IAzureDevOpsApiService azureDevOpsApiService) : IPlatformService
{
    public PlatformType GitPlatformType => PlatformType.AzureDevOps;
